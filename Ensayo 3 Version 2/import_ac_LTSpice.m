function [freq,dB,deg] = import_ac_LTSpice(filename)
%   
%   Importa los datos del archivo de texto FILENAME (ubicado en el 
%   directorio por defecto) obtenido como resultado de un análisis 
%   de alterna (AC Analysis) en el software LTSpice.
%
%   [freq,dB,deg] = import_ac_LTSpice(FILENAME) 
%
