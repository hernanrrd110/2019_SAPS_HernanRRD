...
% En esta sección trabajamos con la señal F0007CH2
...
%%%%% Cálculo de TDH (Distorsión Armónica Total) %%%%%
THD = THD_amano(Modulo1, freq, frec_fund, 3);        % Calcula la THD para 3 armónicos

%dBTDH = thd(vector_senial);  

%%
%%%%% EJERCICIO EXTRA %%%%%
% Calcular la atenuación (en dB) que debe aplicarse sobre los armónicos 2, 3 y 4 de la señal F0011CH2
%   para lograr que la misma tenga una distorsión armónica menor al 5%.

THD_buscado = 4; % TDH Porcentual buscado

factor_atenuador = atenuarTHD(Modulo1, freq, frec_fund, 3, THD_buscado);    % Calcula el factor de atenuación
